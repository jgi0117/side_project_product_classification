...
FNR·FPR은 AI 담당자가 각각 10% 이하를 제안하며 **PO 확정 전**입니다.
...
| FPR / FNR | 각각 ≤10% 제안 | PO가 최종 수치·집계 단위·적용 범위를 결정 |
...
전체 집계 여부를 함께 정해야 합니다. 이미지 FNR ≤10%를 채택하면 같은 단위의 Recall ≥90%가
...
[Google Drive 평가 이미지](https://drive.google.com/drive/folders/1H-wfZyZIEnoOGA3Mr6yhfgsb0a2cdCXR) 중 실제 추론에 사용한 사진을 클래스별 10장씩 소개합니다.

### book — 10장

| 1 | 2 | 3 | 4 | 5 |
|---|---|---|---|---|
| <img src="docs/photo-verification/examples/book-01.jpg" width="180" alt="book 예시 1"> | <img src="docs/photo-verification/examples/book-02.jpeg" width="180" alt="book 예시 2"> | <img src="docs/photo-verification/examples/book-03.jpg" width="180" alt="book 예시 3"> | <img src="docs/photo-verification/examples/book-04.jpg" width="180" alt="book 예시 4"> | <img src="docs/photo-verification/examples/book-05.jpg" width="180" alt="book 예시 5"> |
| <img src="docs/photo-verification/examples/book-06.jpg" width="180" alt="book 예시 6"> | <img src="docs/photo-verification/examples/book-07.jpeg" width="180" alt="book 예시 7"> | <img src="docs/photo-verification/examples/book-08.jpg" width="180" alt="book 예시 8"> | <img src="docs/photo-verification/examples/book-09.jpeg" width="180" alt="book 예시 9"> | <img src="docs/photo-verification/examples/book-10.jpg" width="180" alt="book 예시 10"> |

### computer — 10장

| 1 | 2 | 3 | 4 | 5 |
|---|---|---|---|---|
| <img src="docs/photo-verification/examples/computer-01.jpg" width="180" alt="computer 예시 1"> | <img src="docs/photo-verification/examples/computer-02.jpg" width="180" alt="computer 예시 2"> | <img src="docs/photo-verification/examples/computer-03.jpg" width="180" alt="computer 예시 3"> | <img src="docs/photo-verification/examples/computer-04.jpg" width="180" alt="computer 예시 4"> | <img src="docs/photo-verification/examples/computer-05.jpg" width="180" alt="computer 예시 5"> |
| <img src="docs/photo-verification/examples/computer-06.jpg" width="180" alt="computer 예시 6"> | <img src="docs/photo-verification/examples/computer-07.jpg" width="180" alt="computer 예시 7"> | <img src="docs/photo-verification/examples/computer-08.jpg" width="180" alt="computer 예시 8"> | <img src="docs/photo-verification/examples/computer-09.jpg" width="180" alt="computer 예시 9"> | <img src="docs/photo-verification/examples/computer-10.jpg" width="180" alt="computer 예시 10"> |

### other — 10장

| 1 | 2 | 3 | 4 | 5 |
|---|---|---|---|---|
| <img src="docs/photo-verification/examples/other-01.jpg" width="180" alt="other 예시 1"> | <img src="docs/photo-verification/examples/other-02.jpeg" width="180" alt="other 예시 2"> | <img src="docs/photo-verification/examples/other-03.jpg" width="180" alt="other 예시 3"> | <img src="docs/photo-verification/examples/other-04.jpeg" width="180" alt="other 예시 4"> | <img src="docs/photo-verification/examples/other-05.jpeg" width="180" alt="other 예시 5"> |
| <img src="docs/photo-verification/examples/other-06.jpg" width="180" alt="other 예시 6"> | <img src="docs/photo-verification/examples/other-07.jpg" width="180" alt="other 예시 7"> | <img src="docs/photo-verification/examples/other-08.jpg" width="180" alt="other 예시 8"> | <img src="docs/photo-verification/examples/other-09.jpg" width="180" alt="other 예시 9"> | <img src="docs/photo-verification/examples/other-10.jpg" width="180" alt="other 예시 10"> |
...
AI 담당 제안은 **FNR ≤10%, FPR ≤10%**입니다. PO가 최종 목표 수치와 평가 단위
(이미지/세션), 카테고리별 적용 여부를 결정해 주어야 합니다. 아직 승인된 목표가 아닙니다.
Precision·Recall ≥80%와 함께 관리하되, FNR ≤10%가 승인되면 해당 Recall은 ≥90%를 요구합니다.
...
연동 회의는 **금요일 또는 토요일 중 진행을 제안하며, 구체적인 시간은 BE 담당자와 협의**합니다.

| 일정 제안 | 할 일 / 산출물 |
|---|---|
| **9/24(목)까지** | AI 담당이 input/output 명세 초안, 요청·응답 예시와 오류 구분을 백엔드에 공유 |
| **9/25(금) 또는 9/26(토)** | BE와 협의해 연동 회의 진행: 실제 사진 요청, 응답 파싱, 실패 처리와 timeout 확인 |
| **일요일(9/27) 전** | 연결 확인 목표: 성공·판정거절·기술오류 케이스 점검, 남은 이슈 기록 |
...
### ⑤ 팀 GitHub 코드 연동 및 Jira 백로그 작성 — AI 담당

**9/24(목)까지 팀 GitHub에 코드를 연동하고 Jira 백로그 작성을 완료할 예정입니다.**
데이터 보강, RTMDet 재검증, FastAPI 구축·백엔드 연동 등 후속 작업을 백로그로 정리하겠습니다.

Jira를 처음 사용해 사용법과 팀의 백로그 작성 방식을 익히는 시간이 필요합니다.
이로 인해 정리가 다소 늦어지는 점 양해 부탁드립니다. 목요일까지 코드 연동과 백로그 작성을
마치고 팀에 공유하겠습니다.
